...
public class TabProducts extends Fragment {
    ...
    private TabProductsViewModel mViewModel;

    public static TabProducts newInstance() {
        return new TabProducts();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(TabProductsViewModel.class);
